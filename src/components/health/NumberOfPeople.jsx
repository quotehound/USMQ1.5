...
class Household extends Component {
 ...
 const zip = urlParams.get('zip');
    ...
    this.props.history.push('/preexist' + '?lp=' + lp + '&zip=' + zip + '&health_insurance_plan=ACA_Plan' + '&coverage_time=' + time + '&household_income=' + income + '&weight=' + weight + '&height=' + height);
  ...
  <h2>Get A No Obligation Medicare Insurance Quote</h2>        </div>
